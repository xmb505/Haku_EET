...
## 更新摘要
**变更内容**   
- 新增日志诊断基础设施章节，包含 TeeStderr 双写机制、时间戳日志文件、按模块日志控制
- 新增控制台调试命令章节，详细说明 /debug show ai_need_1 和 /debug show human_presence 命令
- 更新了故障排查指南，增加日志诊断相关工具的使用说明
- 增强了系统可观测性和调试能力
...
EXE->>DISP : show_number(floor, car_id)
DISP->>DISP : 检查floor_display配置
DISP->>IO : 写数码管笔画
