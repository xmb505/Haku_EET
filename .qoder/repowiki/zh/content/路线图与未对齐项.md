...
## 更新摘要
**所做更改**   
- 更新了关门延时配置参数的说明，反映从 500ms 到 2000ms 的变更
- 增强了乘客流程自动化部分的配置细节
- 更新了相关章节的来源引用
...
- [core/io_mapper.py:1-200](file://core/io_mapper.py#L1-L200)
- [core/console.py:678-700](file://core/console.py#L678-700)
...
- 现状
  ...
  - **更新** 配置项 door_close_delay、light_off_delay 已存在，供上层使用。其中 door_close_delay_ms 已从 500ms 调整为 2000ms，提供更长的乘客上下车等待时间。
- 未对齐点
...
- 影响面
  ...
  - 外召响应不完整，影响用户体验与效率。
  - **更新** 增强的关门延时（2000ms）在高流量场景下提供更好的乘客上下车时间窗口。
- 建议补齐路径
...
CheckHall --> |否| ScheduleClose["启动关门 cron<br/>等待 2000ms可配置<br/>可被光幕/按钮取消/推迟"]
ScheduleClose --> LightCheck{"是否还有内召缓存？"}
LightCheck --> |有| Compile["compile 生成路线 → 出发"]
LightCheck --> |无| LightsOff["启动熄灯 cron<br/>无人则关灯"]
...
图表来源
- [core/passenger.py:348-421](file://core/passenger.py#L348-421)
- [core/app.py:446-452](file://core/app.py#L446-452)
- [core/executor.py:685-698](file://core/executor.py#L685-698)
- [config/ui_config.yaml:12-14](file://config/ui_config.yaml#L12-14)

章节来源
- [SPEC.md:856-877](file://SPEC.md#L856-877)
- [SPEC.md:921-924](file://SPEC.md#L921-924)
- [core/app.py:446-452](file://core/app.py#L446-452)
- [core/passenger.py:348-421](file://core/passenger.py#L348-421)
- [core/executor.py:685-698](file://core/executor.py#L685-698)
- [config/ui_config.yaml:12-14](file://config/ui_config.yaml#L12-14)
...
图表来源
- [core/app.py:252-300](file://core/app.py#L252-300)
- [core/app.py:481-540](file://core/app.py#L481-540)
- [core/passenger.py:190-243](file://core/passenger.py#L190-243)

章节来源
- [SPEC.md:860-869](file://SPEC.md#L860-869)
- [README.md:196-202](file://README.md#L196-202)
- [core/app.py:252-300](file://core/app.py#L252-300)
- [core/app.py:481-540](file://core/app.py#L481-540)
...
章节来源
- [SPEC.md:856-894](file://SPEC.md#L856-894)
...
图表来源
- [core/app.py:41-169](file://core/app.py#L41-169)
- [core/passenger.py:112-149](file://core/passenger.py#L112-149)
- [core/executor.py:277-313](file://core/executor.py#L277-313)
- [core/io_client.py:387-454](file://core/io_client.py#L387-454)

章节来源
- [README.md:206-212](file://README.md#L206-212)
- [SPEC.md:726-787](file://SPEC.md#L726-787)
...
- **更新** 关门延时配置（2000ms）在高流量场景下可能略微增加平均等待时间，但显著改善乘客体验。

章节来源
- [SPEC.md:395-454](file://SPEC.md#L395-454)

## 故障排查指南
- 常见问题
  - 外召无效：检查 hall_call 是否被算法层忽略；确认 usermode 已启用。
  - 关门不自动：确认 passenger_flow 未实现；手动 /door close 验证链路。
  - 关门延迟过长：检查 ui_config.yaml 中的 door_close_delay_ms 配置（当前为 2000ms）。
...
章节来源
- [README.md:163-168](file://README.md#L163-168)
- [SPEC.md:878-894](file://SPEC.md#L878-894)

## 结论
- 当前版本在多轿厢支持与底层稳定性方面具备良好基础，但"乘客流程自动化"和"全局群控调度"仍是主要缺口。
- **更新** 关门延时配置从 500ms 提升到 2000ms，为高流量场景提供更好的乘客上下车时间窗口。
...
## 附录
- 配置要点
  - **更新** door_close_delay_ms 配置项位于 ui_config.yaml 中，当前值为 2000ms（原为 500ms），控制外召按钮释放后的自动关门等待时间。
  - light_off_delay 为 passenger_flow 预留参数。
...
章节来源
- [config/ui_config.yaml:12-14](file://config/ui_config.yaml#L12-14)
- [config/config.yaml:58-61](file://config/config.yaml#L58-61)
- [core/console.py:678-700](file://core/console.py#L678-700)